	...
	<fieldset>
		...
		<div id="info_tabs" style="font-size: 10pt;">
			<ul>
				...
				<li><a href="#info_tabs-3">Liste</a></li>
			</ul>
			<div id="info_tabs-1">
				<label for="ref_table">Anfrage zu:</label>
				<select name="ref_table">
					<option value="ot_row" <?php echo ($ticket['ref_table'] == 'ot_row') ? 'selected' : ''; ?>>Bestellung</option>
					<option value="ot_order_list" <?php echo ($ticket['ref_table'] == 'ot_order_list') ? 'selected' : ''; ?>>Produkt</option>
				</select>
